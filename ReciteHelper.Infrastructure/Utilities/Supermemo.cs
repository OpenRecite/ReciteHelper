...
public static class Supermemo
{
    public static double CalculateEFValue(double ef, int q)
    {
    ...
    public static int PredictQValue<TValue>(TValue relRelative, TValue similarity)
    ...
    public static List<Question> GenerateReview(Project project, int count)
    {
